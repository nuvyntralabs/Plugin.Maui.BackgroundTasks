# Plugin.Maui.BackgroundTasks — AI Coding Agent Guide

## Project

Unified Android/iOS background-task abstraction. Schedule one-time and periodic work through JobScheduler and BGTaskScheduler.
...
- Paper: https://nuvyntralabs.github.io/packages/plugin-maui-background-tasks/
